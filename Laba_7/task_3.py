...
while 1:
    ...
    frame_filt = cv2.GaussianBlur(frame_filt,ksize=(15,15),sigmaX=0)
    frame_filt = cv2.Canny(frame_filt, 7, 21, 7)
    lines = cv2.HoughLinesP(frame_filt, rho = 1, theta = math.pi/180, threshold = 30, minLineLength = 50, maxLineGap= 5)
